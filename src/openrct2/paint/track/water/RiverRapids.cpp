    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (trackElement.HasChain())
        PaintRiverRapidsTrack25Deg(session, direction, height, river_rapids_track_pieces_25_deg_up_chain, supportType);
    else
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (trackElement.HasChain())
        PaintRiverRapidsTrack25DegToFlatB(
            session, direction, height, river_rapids_track_pieces_flat_to_25_deg_up_chain, supportType);
    else
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    if (trackElement.HasChain())
        PaintRiverRapidsTrack25DegToFlatA(
            session, direction, height, river_rapids_track_pieces_25_deg_up_to_flat_chain, supportType);
    else
