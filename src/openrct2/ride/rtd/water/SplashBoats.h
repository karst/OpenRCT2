...
constexpr RideTypeDescriptor SplashBoatsRTD =
{
    ...
    .TrackPaintFunctions = TrackDrawerDescriptor({
        ...
        .enabledTrackGroups = {TrackGroup::straight, TrackGroup::stationEnd, TrackGroup::slope, TrackGroup::slopeSteepDown, TrackGroup::sBend, TrackGroup::curve, TrackGroup::onridePhoto, TrackGroup::liftHill},
        .extraTrackGroups = {},
    }),
    ...
    .Flags = kRtdFlagsHasThreeColours | EnumsToFlags(RtdFlag::hasLeaveWhenAnotherVehicleArrivesAtStation,
                     ...
                     RtdFlag::showInTrackDesigner, RtdFlag::slightlyInterestingToLookAt, RtdFlag::upInclineRequiresLift),
