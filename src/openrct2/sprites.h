...
enum
{
    ...
    SPR_G2_GIGA_RC_BOOSTER_ALT_NE_SW,
    SPR_G2_GIGA_RC_BOOSTER_ALT_NW_SE,
    SPR_G2_GIGA_RC_BOOSTER_ALT_SW_NE,
    SPR_G2_GIGA_RC_BOOSTER_ALT_SE_NW,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_CLOSED_NE_SW,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_CLOSED_NW_SE,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_CLOSED_SW_NE,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_CLOSED_SE_NW,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_OPEN_NE_SW,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_OPEN_NW_SE,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_OPEN_SW_NE,
    SPR_G2_GIGA_RC_BLOCK_BRAKE_ALT_OPEN_SE_NW,
    SPR_G2_GIGA_RC_BRAKE_ALT_CLOSED_NE_SW,
    SPR_G2_GIGA_RC_BRAKE_ALT_CLOSED_NW_SE,
    SPR_G2_GIGA_RC_BRAKE_ALT_CLOSED_SW_NE,
    SPR_G2_GIGA_RC_BRAKE_ALT_CLOSED_SE_NW,
    SPR_G2_GIGA_RC_BRAKE_ALT_OPEN_NE_SW,
    SPR_G2_GIGA_RC_BRAKE_ALT_OPEN_NW_SE,
    SPR_G2_GIGA_RC_BRAKE_ALT_OPEN_SW_NE,
    SPR_G2_GIGA_RC_BRAKE_ALT_OPEN_SE_NW,
    SPR_G2_GIGA_RC_DIAG_BRAKES,
    SPR_G2_GIGA_RC_DRIVE_TYRE_NE_SW = SPR_G2_GIGA_RC_DIAG_BRAKES + 6,
    SPR_G2_GIGA_RC_DRIVE_TYRE_NW_SE,
    SPR_G2_GIGA_RC_DRIVE_TYRE_SW_NE,
    SPR_G2_GIGA_RC_DRIVE_TYRE_SE_NW,
    SPR_G2_GIGA_RC_POWERED_LIFT_1,
    SPR_G2_GIGA_RC_POWERED_LIFT_2,
    SPR_G2_GIGA_RC_POWERED_LIFT_3,
    SPR_G2_GIGA_RC_POWERED_LIFT_4,
    SPR_G2_GIGA_RC_POWERED_LIFT_ALT_1,
    SPR_G2_GIGA_RC_POWERED_LIFT_ALT_2,
    SPR_G2_GIGA_RC_POWERED_LIFT_ALT_3,
    SPR_G2_GIGA_RC_POWERED_LIFT_ALT_4,
