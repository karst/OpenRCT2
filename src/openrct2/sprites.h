...
enum
{
    ...
    SPR_G2_BUTTON_HIDE_VEGETATION = SPR_G2_BEGIN + 143,
    SPR_G2_BUTTON_HIDE_SCENERY = SPR_G2_BEGIN + 144,
    SPR_G2_BUTTON_HIDE_VEHICLES = SPR_G2_BEGIN + 145,
    SPR_G2_BUTTON_HIDE_SUPPORTS = SPR_G2_BEGIN + 146,
    ...
    SPR_G2_HYBRID_LIFT_BEGIN = SPR_G2_HYBRID_TRACK_POWERED_LIFT + 4,
    ...
    SPR_G2_SINGLE_RAIL_LIFT_BEGIN = SPR_G2_SINGLE_RAIL_TRACK_SMALL_FLAT_TO_STEEP + 20,
    ...
    SPR_G2_RIDE_CONSTRUCTION_CABLE_SUPPORTLESS = SPR_G2_ALPINE_END,
    SPR_G2_RIDE_CONSTRUCTION_CABLE_SUPPORTED = SPR_G2_ALPINE_END + 1,

    // End calculation of G2.
    SPR_G2_END = SPR_G2_RIDE_CONSTRUCTION_CABLE_SUPPORTED + 1,
